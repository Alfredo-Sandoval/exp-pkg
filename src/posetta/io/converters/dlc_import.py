...
def _instance_points(points: dict[str, tuple[float, float]]) -> dict[str | Keypoint, Any]:
    from posetta.core.annotations import Point
...
def _labels_from_tracking_df(
    ...
    *,
    ...
    """Convert a tracking table into the canonical `posetta.model.Labels` object."""
...
def _labels_from_tracking_df_project(
    ...
    *,
    ...
    from posetta.core.annotations import Instance, LabeledFrame
    from posetta.model import Labels
