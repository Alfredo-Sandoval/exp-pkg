...
def test_cli_describe_json_pins_machine_contract(capsys) -> None:
    ...
    assert payload["commands"] == [
        ...
        "describe",
        "inspect",
        "import behavior behavior-csv",
        "import behavior behavior-json",
        "import behavior boris-csv",
        "import behavior bsoid-csv",
        "import behavior keypoint-moseq-csv",
        "import behavior simba-csv",
        "import calibration anipose",
        "import calibration opencv-stereo-yaml",
        "import events events-csv",
        "import pose dlc-csv",
        "import pose dlc-h5",
        ...
        "import synchronization synchronization-csv",
        "project describe",
        "project init",
